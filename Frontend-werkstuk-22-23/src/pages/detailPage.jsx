    ...
    >
      ...
      >
          ...
          <div className="image-container">
            ...
            <p>
              Hier kun je dieper duiken in de fascinerende wereld van deze
              oude beschaving. Ontdek de betoverende architectuur, leer over de
          ...
          <div className="author-container">
            <h2>Author: Abdeslam Boutaarourt</h2>
          </div>
          <div className="button-container">
            <button>
              <Link to="/de-oude-egypte">More Info</Link>
            </button>
          </div>
        </motion.div>
      </div>
